...
public class PasseggeroController {
    ...
    public void updatePasseggero(@PathVariable("IDPasseggero") Long IDPasseggero, @PathVariable("attributo") String attributo, @PathVariable("valore") String valore){
        passeggeroService.updatePasseggero(IDPasseggero, attributo, valore);
    }
}